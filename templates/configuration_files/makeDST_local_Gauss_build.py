#!/usr/bin/env python2
'''This is a template for making DST from an EventNumber in a local Gauss build. It will generate MC, put it through the detector, run the trigger on it, and strip it.
'''
